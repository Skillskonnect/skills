...
class BookitController {
    ...
    private static function get_step_naviation() {
    	$step_navigation = [
    		[ 'key'  => 'category', 'menu' => __('Category'), 'title' => __('Select Category', 'bookit'), 'requiredFields' => [], 'validation' => false ],
		    [ 'key'  => 'service', 'menu' => __('Service'), 'title' => __('Select Service', 'bookit'), 'requiredFields' => ['category_id'], 'validation' => false ],
		    [ 'key'  => 'dateTime', 'menu' => __('Date'), 'title' => __('Select Time & Employee', 'bookit'), 'requiredFields' => ['category_id', 'service_id'], 'validation' => false ],
		    [ 'key'  => 'detailsForm', 'menu' => __('Details'), 'title' => __('Details', 'bookit'), 'requiredFields' => ['service_id', 'staff_id', 'date_timestamp', 'start_time'], 'validation' => true ],
		    [ 'key'  => 'payment', 'menu' => __('Payment'), 'title' => __('Payment', 'bookit'), 'requiredFields' => ['service_id', 'staff_id', 'date_timestamp', 'start_time', 'end_time', 'email', 'full_name' ], 'validation' => false ],
		    [ 'key'  => 'confirmation', 'menu' => __('Confirmation'), 'title' => __('Confirmation', 'bookit'), 'requiredFields' => ['service_id', 'staff_id', 'date_timestamp', 'start_time', 'end_time',  'email', 'full_name', 'payment_method'], 'validation' => true ],//todo
